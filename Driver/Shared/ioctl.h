...
#define ARTIFACT_TYPE_PREFETCH    0x01
#define ARTIFACT_TYPE_SHIMCACHE   0x02
#define ARTIFACT_TYPE_BAM         0x04
#define ARTIFACT_TYPE_AMCACHE     0x08
#define ARTIFACT_TYPE_ALL         0x0F

#define MAX_ARTIFACT_ENTRIES      32
